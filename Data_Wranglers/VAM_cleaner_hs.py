...
def info(i, data):
    ...
    try:
        storage.append(joint_extractor(data[i]['staff_info'],['CPCTMATA','CPETG09A'],'math_class_size'))
        storage.append(joint_extractor(data[i]['staff_info'],['CPCTENGA','CPETG10A'],'eng_class_size'))
    except KeyError:
        print(i)
...
def academic(i,data):
    ...
    storage.append(joint_extractor(data[i]['stud_info'],['CAMPUS','CAMPUS'],'Campus'))
    try:
        storage.append(joint_extractor(data[i]['edu6'],['CA009QM'+i+'R','CA009RM'+i+'R'],'TAKS_math_gr9'))
    except KeyError:
        storage.append(joint_extractor(data[i]['edu6'],['CA009TM'+i+'R','CA009PM'+i+'R'],'TAKS_math_gr9'))
    try:
        storage.append(joint_extractor(data[i]['edu6'],['CA009QR'+i+'R','CA009RR'+i+'R'],'TAKS_reading_gr9'))
    except KeyError:
        storage.append(joint_extractor(data[i]['edu6'],['CA009TR'+i+'R','CA009PR'+i+'R'],'TAKS_reading_gr9'))
    try:
        storage.append(joint_extractor(data[i]['edu6'],['CA010QM'+i+'R','CA010RM'+i+'R'],'TAKS_math_gr10'))
    except KeyError:
        storage.append(joint_extractor(data[i]['edu6'],['CA010TM'+i+'R','CA010PM'+i+'R'],'TAKS_math_gr10'))
    try:
        storage.append(joint_extractor(data[i]['edu6'],['CA010QE'+i+'R','CA010RE'+i+'R'],'TAKS_ELA_gr10'))
    except KeyError:
        storage.append(joint_extractor(data[i]['edu6'],['CA010TE'+i+'R','CA010PE'+i+'R'],'TAKS_ELA_gr10'))
    try:
...
aca_file.to_csv('/Users/vincentcarse/Desktop/Thesis/Texas_Education/Regression/VAM_reg/aca_file_hs.csv')
fin_file.to_csv('/Users/vincentcarse/Desktop/Thesis/Texas_Education/Regression/VAM_reg/fin_file_hs.csv')
info_file.to_csv('/Users/vincentcarse/Desktop/Thesis/Texas_Education/Regression/VAM_reg/info_file_hs.csv')
